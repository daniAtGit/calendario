                ...
                <div class="col-10">
                    <form method="post" action="{{route('persone.update', $persona)}}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="nome" class="form-control" value="{{$persona->nome}}" required>
                        </div>

                        <div>
                            <label for="colore" class="form-label">Colore <span class="text-danger">*</span></label>
                            <input type="color" name="colore" class="form-control" value="{{$persona->colore}}" required>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="radio" name="invio" value="1" @checked($persona->invio === true)> Si
                            <input type="radio" name="invio" value="0" @checked($persona->invio === false)> No
                        </div>
